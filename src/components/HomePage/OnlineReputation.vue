<template>
  <section class="relative">
    <div class="mx-auto container max-xl:max-w-[100%] max-xl:px-5">
      <div class="flex flex-center flex-wrap  mt-2">
        <div class="lg:w-5/12 prose font-primary md:w-full sm:w-full sm:mb-5 md:mb-5">
          <div class="mx-auto w-full md:w-full justify-center sm:w-full">
            ...
            <p class="text-xl leading-9 my-5">
              Don't let email bounces and spam complaints tarnish your brand's image.
              Ensure a pristine sender reputation with our Email Verification Service.
            </p>

            <button
              class="py-2.5 px-8 bg-[#E24949] text-white rounded-full text-[15px]"
            >
              Protect Now
            </button>
          </div>
